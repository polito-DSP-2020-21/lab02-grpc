...
var imageSchema = JSON.parse(fs.readFileSync(path.join('.',  'json_schemas', 'image_schema.json')).toString());
var validator = new Validator({ allErrors: true });
//validator.ajv.addMetaSchema(require('ajv/lib/refs/json-schema-draft-07.json'));
validator.ajv.addSchema([userSchema, taskSchema, imageSchema]);
...
//new REST APIs related to the management of images
app.post('/api/tasks/:taskId/images', storage.uploadImg, imageController.addImage);
app.get('/api/tasks/:taskId/images/:imageId', imageController.getSingleImage);
app.delete('/api/tasks/:taskId/images/:imageId', imageController.deleteSingleImage);
app.get('/api/tasks/:taskId/images/:imageId/imageFile', imageController.getSingleImageFile);
